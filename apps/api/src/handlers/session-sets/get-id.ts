...
import { createSuccessData, createErrorDataWithLogging, handleRepositoryError } from '../../utils/api-helpers';
...
export async function handleGetSessionSetById(c: Context<AppContext>) {
